 ...
 *
 */
public class CloudUpdateScreen extends BBCloudScreen implements FieldChangeListener {

	/**
	 * Creates a new Update Screen
	 * 
	 * @param serverId ID of the cloud server.
	 */
	public CloudUpdateScreen(String serverId){
		...
		VerticalFieldManager vMgr = new VerticalFieldManager(Field.FIELD_HCENTER);
	...
	public void fieldChanged(Field field, int context) {
		...
		if(field == updateBtn) {
			if(serverNameField.getText() == "" && adminPassField.getText() == "" ) {
				...
				try {
					...
					attr.addAttribute("", "adminPass", "adminPass", "TEXT", adminPassField.getText());
			        ...
			        writer.endDocument();
			        dispatcher.setCommand(HttpRequestDispatcher.UPDATE_SERVER, baos.toString());
